...
if (isset($_POST['username']) && isset($_POST['register-email']) && isset($_POST['password']) && isset($_POST['tandc'])){
    if ($_POST['tandc'] == 'on'){
        ...
        $checkUsernameQuery = "SELECT * FROM gitsocialusers WHERE username = '$username'";
        $checkUsernameResult = mysqli_query($conn, $checkUsernameQuery);

        $checkEmailQuery = "SELECT * FROM gitsocialusers WHERE email = '$email'";
        ...
        $query = "INSERT INTO gitsocialusers (username, email, password) VALUES ('$username', '$email', '$password')";
...
if (isset($_POST['email']) && isset($_POST['password'])){
    ...
    $query = "SELECT * FROM gitsocialusers WHERE email = '$email' AND password = '$password'";
    ...
    <body>
        ...
        <div class="v-banner">
            ...
            <div class="hero">
                <div class="form-ctnr">
                    <div class="logo">
                        <a href="index.php">
                            <img src="./img/GitSocial-logo.png" alt="The Logo">
                        </a>
                        <p>Social Media for Programmers, by Programmers.</p>
                    </div>
        ...
        <script>
            window.onload = function() {
                ...
                xhr.open('GET', './inc/logout.php', true);
                xhr.send();
            }
            window.onload = function() {
                var url = window.location.href;
                if (url.indexOf('register=true') != -1) {
                    register();
